...
//		reqContent.put("app_auth_token", ""); //应用授权概述
	 ...
	 * @throws Exception
	 */
	public String tradeRefundQuery(Map<String, Object> reqData) throws Exception {
		String url = SDKConfig.getConfig().getTransUrlPrefix();
		Map<String, String> map = this.fillRequestData(reqData,SDKConfig.getConfig().getTraderefundQuery());
		String resp = this.post(map, url, AliPayConstants.CHARSET_UTF_8);
		String methodName = map.get("method");
		return this.processResponse(methodName,resp);
	}
	 ...
	 * @throws Exception
	 */
	public String tradeRefund(Map<String, Object> reqData) throws Exception {
		String url = SDKConfig.getConfig().getTransUrlPrefix();
		Map<String, String> map = this.fillRequestData(reqData,SDKConfig.getConfig().getTradeRefund());
		String resp = this.post(map, url, AliPayConstants.CHARSET_UTF_8);
		String methodName = map.get("method");
		return this.processResponse(methodName,resp);
	}
	 ...
	 * @throws Exception
	 */
	public String tradeQuery(Map<String, Object> reqData) throws Exception {
		String url = SDKConfig.getConfig().getTransUrlPrefix();
		Map<String, String> map = this.fillRequestData(reqData,SDKConfig.getConfig().getTradeQuery());
		String resp = this.post(map, url, AliPayConstants.CHARSET_UTF_8);
		String methodName = map.get("method");
		return this.processResponse(methodName,resp);
	}
